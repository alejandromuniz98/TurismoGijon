...
import cachopo from '../images/cachopo.jpg'; // Nuevo plato
...
const platos = [
  ...
  { img: cachopo, title: "Cachopo", desc: "El cachopo es uno de los platos más populares de la gastronomía asturiana. Se trata de dos filetes de carne empanados y rellenos de jamón y queso, que luego se fríen hasta quedar crujientes. Es un plato delicioso y muy sabroso, ideal para disfrutar con una sidra asturiana." } // Nuevo plato
];
